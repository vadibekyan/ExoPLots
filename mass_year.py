...
def planet_discovery_stat():
    # Function to display statistics about planet discovery

    # Call the function creating_data_to_plot() to obtain relevant data
    ...
    print('-----  Some Stats -----')
    print(f'{len(nea_full_table)} planets discovered so far\n')
    print(f'{len(nea_mass_year_Transit)} via Transiting/TTV methods')
    print(f'{len(nea_mass_year_RV)} via RV method')
    print(f'{len(nea_mass_year_Microlensing)} via Microlensing method')
    print(f'{len(nea_mass_year_Imaging)} via Imaging method')
    print(f'{len(nea_mass_year_Other)} by other methods')
